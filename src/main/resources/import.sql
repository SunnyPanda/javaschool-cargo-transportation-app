...
insert into trucks (id, reg_number, shift_size, capacity, state, current_city_id, order_id) values (1, 'GHHGGGG', '2', '35', 0, 4, 1);
insert into trucks (id, reg_number, shift_size, capacity, state, current_city_id, order_id) values (2, 'FE78430', '1', '100', 0, 1, 2);
...
insert into drivers (id, personal_number, first_name, last_name, hours_per_month, status, current_truck_id, current_city_id, order_id) values (1, '34098753', 'Аркадий', 'Исааков', 23, 1, 2, 3, 1);
insert into drivers (id, personal_number, first_name, last_name, hours_per_month, status, current_truck_id, current_city_id, order_id) values (2, '56084545', 'Вениамин', 'Пунктуальный', 46, 2, 2, 1, 3);
